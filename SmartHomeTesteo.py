...
a: Abre el archivo para agregar datos al final. Si el archivo no existe, lo crea.
r: Abre el archivo para leer los datos que contiene.
w: Abre el archivo para escribir datos. Si el archivo no existe, lo crea. Si existe sobrescribe la informacion que contenga.
a+: Abre el archivo para leer y escribir datos en el.
"""
import os 
def crearArchivoUsuario(): #x ahora crea un archivo para los usuarios para posteriormente añadir la info
